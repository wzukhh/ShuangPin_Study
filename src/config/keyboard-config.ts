...
const keyboardConfigs: KeyboardConfig[] = [
    {
        code: 'xiaohe',
        name: '小鹤',
        keys: {
...
const commonInitials: Record<string, string> = {
    // 第1行
    q: 'q',
    w: 'w',
    r: 'r',
...
// 获取当前配置（默认使用第一套配置）
export function getCurrentConfig(): KeyboardConfig {
...
// 获取所有配置列表
export function getAllConfigs(): KeyboardConfig[] {
    return keyboardConfigs;
}

// ES6 模块导出
export { keyboardConfigs, commonInitials };
